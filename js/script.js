let listH1 = document.querySelectorAll("h1");
let h1 = listH1[0];
// h1.outerHTML="<h2>1- Revision HTML, CSS et Javascript:</h2>";
​
//Modifier l'element
h1.textContent = "1- Revision HTML, CSS et Javascript:";
h1.style.color = "red";
...
setTimeout( () => getAllH2().forEach( setGreen ), 1000);
setTimeout( () => getAllP().forEach( setRed ), 1000);
setTimeout( () => getAllH2().forEach( setRed ), 3000);
setTimeout( () => getAllP().forEach( setGreen ), 3000);
